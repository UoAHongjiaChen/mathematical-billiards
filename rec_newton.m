...
plot3(p10_alpha4_1_mat(:,1), p10_alpha4_1_mat(:,2), p10_alpha4_1_mat(:,3), 'b^'); hold on  % P_0 = 0.125
plot3(p10_alpha4_1_mat(:,1), atan(4.*p10_alpha4_1_mat(:,1)./1), repmat(0.375, size(p10_alpha4_1_mat(:,1))), 'b<'); hold on
plot3(p10_alpha4_1_mat(:,1), atan(4.*p10_alpha4_1_mat(:,1)./1), repmat(0.625, size(p10_alpha4_1_mat(:,1))), 'bv'); hold on
plot3(p10_alpha4_1_mat(:,1), atan(4.*p10_alpha4_1_mat(:,1)./1), repmat(0.875, size(p10_alpha4_1_mat(:,1))), 'b>'); hold on
...
plot3(p10_alpha2_3_mat(:,1), p10_alpha2_3_mat(:,2), p10_alpha2_3_mat(:,3), 'm-'); hold on
%plot3(p10_alpha2_3_mat(:,1), atan(2.*p10_alpha2_3_mat(:,1)./3), repmat(3/4, size(p10_alpha2_3_mat(:,1))), 'm.'); hold on
plot3(x, atan(2.*x./3), 0.75*ones(size(x)), 'mh'); hold on

set(gca,'XLim',[0 max(p10_alpha3_2_mat(:,1))], 'YLim',[0 pi/2], 'ZLim',[0 1]);
xlabel('A - aspect ratio of rectangle')
ylabel('\alpha_0 - angle')
zlabel('P_0 - position')
yticks([0 pi/4 pi/2])
yticklabels({'0','\pi/4', '\pi/2'})
